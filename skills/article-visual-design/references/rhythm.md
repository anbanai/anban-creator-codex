...
模板位于 `__PLUGIN_ROOT__/templates/article/`：
...
- 模板路径: __PLUGIN_ROOT__/templates/article/{template}.yaml
- 选择理由: {1 句话说明为什么选这个模板}
- 章节数: {N}
...
- 模板路径: __PLUGIN_ROOT__/templates/article/long-form-essay.yaml
...
- 所选模板: listicle
- 模板路径: __PLUGIN_ROOT__/templates/article/listicle.yaml
...
- 文章标题: 手冲咖啡的 4 个关键步骤
- 所选模板: tutorial
- 模板路径: __PLUGIN_ROOT__/templates/article/tutorial.yaml
